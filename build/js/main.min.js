...
/* harmony import */ var _modules_show_more__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/show-more */ "./js/modules/show-more.js");
/* harmony import */ var _modules_show_more__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_show_more__WEBPACK_IMPORTED_MODULE_2__);
...
var accordion = document.querySelector(".footer__group");
var accordionItems = accordion.querySelectorAll(".accordion-item");
var getSelectors = function getSelectors(accordionItem) {
  var minusButton = accordionItem.querySelector("button.minus-button");
  var plusButton = accordionItem.querySelector("button.plus-button");
  var navGroup = accordionItem.querySelector("ul.nav-group");
  return {
...
var hideAccordionItem = function hideAccordionItem(accordionItem) {
  var _getSelectors = getSelectors(accordionItem),
    minusButton = _getSelectors.minusButton,
    plusButton = _getSelectors.plusButton,
    navGroup = _getSelectors.navGroup;
  minusButton.classList.add("hide");
  plusButton.classList.remove("hide");
  navGroup.classList.add("hide");
};
var showAccordionItem = function showAccordionItem(accordionItem) {
  var _getSelectors2 = getSelectors(accordionItem),
    minusButton = _getSelectors2.minusButton,
    plusButton = _getSelectors2.plusButton,
    navGroup = _getSelectors2.navGroup;
  minusButton.classList.remove("hide");
  plusButton.classList.add("hide");
  navGroup.classList.remove("hide");
};
var showControlsIfJSEnabled = function showControlsIfJSEnabled(navList, telList) {
  accordion.classList.add("js-enabled");
  accordionItems.forEach(hideAccordionItem);
};
showControlsIfJSEnabled();
accordion.addEventListener("click", function (event) {
  var triggerEvent = event.target.classList.contains("footer__navigation-header") || event.target.classList.contains("footer__contacts-header") || event.target.closest(".footer__navigation-header") || event.target.closest(".footer__contacts-header");
  if (!triggerEvent) {
    return;
  }
  var currentAccordionItem = event.target.closest(".accordion-item");
  var _getSelectors3 = getSelectors(currentAccordionItem),
    navGroup = _getSelectors3.navGroup;
  var isAccordionItemHidden = navGroup.classList.contains("hide");
  accordionItems.forEach(hideAccordionItem);
...
var form = new pristinejs__WEBPACK_IMPORTED_MODULE_1___default.a(document.getElementById("bla-bla-form"));
...
Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.querySelector("#modal-phone-mask"), maskOptions);
...
window.addEventListener("DOMContentLoaded", function () {
  [].forEach.call(document.querySelectorAll("#modal-phone-mask"), function (input) {
    var keyCode;
    function mask(event) {
...
var mobExtraText = document.querySelector(".about-company__text-mob");
var hideElementMobMin = function hideElementMobMin(mobMin) {
  mobMin.classList.add("hidden-mobile");
};
var mobMin = document.querySelector(".about-company__extra-text-mob");
var showElementMobMin = function showElementMobMin(mobMin) {
  mobMin.classList.remove("hidden-mobile");
};
var extraText = document.querySelector(".about-company__extra-text");
var showElementExtraText = function showElementExtraText(extraText) {
  extraText.classList.remove("hidden");
};
var hideElementExtraText = function hideElementExtraText(extraText) {
  extraText.classList.add("hidden");
};
var buttonAbout = document.querySelector(".about-company__button");
var showAboutCompanyButton = function showAboutCompanyButton(buttonAbout) {
...
var showButtonHide = function showButtonHide(buttonHide, buttonMore) {
  buttonHide.classList.remove("hidden");
  buttonMore.classList.add("hidden");
};
var showButtonMore = function showButtonMore(buttonHide, buttonMore) {
...
var minimizeTextIfJsEnabled = function minimizeTextIfJsEnabled() {
  hideElementMobMin(mobMin);
  hideElementExtraText(extraText);
