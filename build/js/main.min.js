...
/* harmony import */ var _modules_mask__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_mask__WEBPACK_IMPORTED_MODULE_5__);
...
var anchors = document.querySelectorAll('span[href*="#"]');
...
var mobExtraText = document.querySelector(".extra-text-mob");
var jsWorking = function jsWorking(buttonAbout) {
...
var showMore = function showMore(extraText, buttonHide, buttonMore) {
  extraText.classList.remove("hidden");
  mobExtraText.style.display = "block";
  buttonHide.classList.remove("hidden");
  buttonMore.classList.add("hidden");
};
var showLess = function showLess(extraText, buttonHide, buttonMore) {
